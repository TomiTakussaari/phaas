...
public class UsersFromEnvironmentStringCreator {
    ...
    public static void main(String... args) {
        ...
        apiUsersService.createUser("testing-user", PasswordEncodingAlgorithm.DEFAULT_SHA256ANDBCRYPT, Collections.singletonList(ApiUsersService.ROLE.USER), password, sharedSecret);
