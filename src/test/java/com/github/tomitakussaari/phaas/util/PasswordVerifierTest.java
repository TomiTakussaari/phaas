...
public class PasswordVerifierTest {
    ...
    private final ProtectionScheme currentProtectionScheme = new ProtectionScheme(1, PasswordEncodingAlgorithm.DEFAULT_SHA256ANDBCRYPT, salt+":::"+Encryptors.text(password, salt).encrypt(encryptionKey));
    private final ProtectionScheme newProtectionScheme = new ProtectionScheme(1, PasswordEncodingAlgorithm.DEFAULT_SHA256ANDBCRYPT, salt+":::"+Encryptors.text(password, salt).encrypt(encryptionKeyTwo));
